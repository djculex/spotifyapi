<div class="table-responsive">
    ...
    <ul class="nav flex-column nav-link" id="spotifyDateNav"
        style="display: flex;position: relative;margin: 0 auto 0 auto;text-align: center;width: fit-content;">
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="<{$weeklyLink}>"
               style="display: inline-block;padding: 15px 15px;"><{$lastweek_text}></a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" href="<{$alltimeLink}>"
               style="display: inline-block;padding: 15px 15px;"><{$alltime}></a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" href="<{$lastmonthLink}>"
               style="display: inline-block;padding: 15px 15px;"><{$lastmonth}></a>
        </li>
    </ul>
    <div class="mw-100 p-3 mb-2 bg-danger text-white">
        <h1 class="text-center"><i id="spotifyalltimechartL" class="bi bi-stars"></i><{$title}><i
                    id="spotifyalltimechartR" class="bi bi-stars"></i></h1>
    ...
    <table class="table ">
        ...
        <{section name=i loop=$chart}>
            <tr>
                ...
                <td class="w-25">
                    <img src="<{$chart[i].image}>" class="img-fluid img-thumbnail" height="100px" width="75px"
                         alt="<{$chart[i].album}> - <{$chart[i].year}>">
                </td>
