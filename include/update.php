 ...
 * @return bool|null
 */
function xoops_module_update_spotifyapi($module, $prev_version = null)
{
    $ret = null;
    if ($prev_version < 10) {
        $ret = update_spotifyapi_v10($module);
    }
 ...
 * @return bool
 */
function update_spotifyapi_v10($module)
{
    global $xoopsDB;
...
function spotifyapi_check_db($module)
{
    ...
    $table   = $GLOBALS['xoopsDB']->prefix('spotifyapi_images');
    $field   = 'img_exif';
